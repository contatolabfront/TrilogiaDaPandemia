...
// AutoWalk
struct AutoWalk_t866CC412078ADE3A6A4941ADE1143F8EEA7A29E7;
// UnityEngine.Camera
...
// AutoWalk
struct AutoWalk_t866CC412078ADE3A6A4941ADE1143F8EEA7A29E7  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	// System.Boolean AutoWalk::isWalking
	bool ___isWalking_5;
	// UnityEngine.Transform AutoWalk::mainCamera
	Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* ___mainCamera_6;
	// System.Single AutoWalk::speed
	float ___speed_7;
	// System.Boolean AutoWalk::walkWhenTriggered
	bool ___walkWhenTriggered_8;
	// System.Boolean AutoWalk::walkWhenLookDown
	bool ___walkWhenLookDown_9;
	// System.Double AutoWalk::thresholdAngle
	double ___thresholdAngle_10;
	// System.Boolean AutoWalk::freezeYPosition
	bool ___freezeYPosition_11;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AutoWalk_Start_mEB7D239E4A7CD136E9C34C4A2A9E9DDFBC7399A7 (AutoWalk_t866CC412078ADE3A6A4941ADE1143F8EEA7A29E7* __this, const RuntimeMethod* method) 
{
	{
		...
		__this->___mainCamera_6 = L_1;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___mainCamera_6), (void*)L_1);
		// }
		return;
	}
}
// System.Void AutoWalk::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AutoWalk_Update_m66A87195D29D36F6CE1B712BA011DB0134CCB4FC (AutoWalk_t866CC412078ADE3A6A4941ADE1143F8EEA7A29E7* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_3), 0, sizeof(V_3));
	{
		...
		bool L_0 = __this->___walkWhenTriggered_8;
		if (!L_0)
		{
			goto IL_0021;
		}
	...
	{
		bool L_1 = __this->___walkWhenLookDown_9;
		if (L_1)
		{
			goto IL_0021;
		}
	...
	{
		bool L_2 = __this->___isWalking_5;
		if (L_2)
		{
			goto IL_0021;
		}
...
IL_0021:
	{
		...
		bool L_3 = __this->___walkWhenTriggered_8;
		if (!L_3)
		{
			goto IL_0040;
		}
	...
	{
		bool L_4 = __this->___walkWhenLookDown_9;
		if (L_4)
		{
			goto IL_0040;
		}
	...
	{
		bool L_5 = __this->___isWalking_5;
		if (!L_5)
		{
			goto IL_0040;
		}
...
IL_0040:
	{
		...
		bool L_6 = __this->___walkWhenLookDown_9;
		if (!L_6)
		{
			goto IL_009b;
		}
	...
	{
		bool L_7 = __this->___walkWhenTriggered_8;
		if (L_7)
		{
			goto IL_009b;
		}
	...
	{
		bool L_8 = __this->___isWalking_5;
		if (L_8)
		{
			goto IL_009b;
		}
	...
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_9 = __this->___mainCamera_6;
		NullCheck(L_9);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_10;
		...
		double L_13 = __this->___thresholdAngle_10;
		if ((!(((double)((double)L_12)) >= ((double)L_13))))
		{
			goto IL_009b;
		}
	}
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_14 = __this->___mainCamera_6;
		NullCheck(L_14);
...
IL_009b:
	{
		...
		//     (mainCamera.transform.eulerAngles.x <= thresholdAngle ||
		//         mainCamera.transform.eulerAngles.x >= RIGHT_ANGLE))
		bool L_18 = __this->___walkWhenLookDown_9;
		if (!L_18)
		{
			goto IL_00f4;
		}
	...
	{
		bool L_19 = __this->___walkWhenTriggered_8;
		if (L_19)
		{
			goto IL_00f4;
		}
	...
	{
		bool L_20 = __this->___isWalking_5;
		if (!L_20)
		{
			goto IL_00f4;
		}
	...
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_21 = __this->___mainCamera_6;
		NullCheck(L_21);
		...
		double L_25 = __this->___thresholdAngle_10;
		if ((((double)((double)L_24)) <= ((double)L_25)))
		{
			goto IL_00ed;
		}
	}
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_26 = __this->___mainCamera_6;
		NullCheck(L_26);
...
IL_00f4:
	{
		...
		//     mainCamera.transform.eulerAngles.x >= thresholdAngle &&
		//     mainCamera.transform.eulerAngles.x <= RIGHT_ANGLE)
		bool L_30 = __this->___walkWhenLookDown_9;
		if (!L_30)
		{
			goto IL_014f;
		}
	...
	{
		bool L_31 = __this->___walkWhenTriggered_8;
		if (!L_31)
		{
			goto IL_014f;
		}
	...
	{
		bool L_32 = __this->___isWalking_5;
		if (L_32)
		{
			goto IL_014f;
		}
	...
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_33 = __this->___mainCamera_6;
		NullCheck(L_33);
		...
		double L_37 = __this->___thresholdAngle_10;
		if ((!(((double)((double)L_36)) >= ((double)L_37))))
		{
			goto IL_014f;
		}
	}
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_38 = __this->___mainCamera_6;
		NullCheck(L_38);
...
IL_014f:
	{
		...
		//     mainCamera.transform.eulerAngles.x >= thresholdAngle &&
		//         mainCamera.transform.eulerAngles.x >= RIGHT_ANGLE)
		bool L_42 = __this->___walkWhenLookDown_9;
		if (!L_42)
		{
			goto IL_01a8;
		}
	...
	{
		bool L_43 = __this->___walkWhenTriggered_8;
		if (!L_43)
		{
			goto IL_01a8;
		}
	...
	{
		bool L_44 = __this->___isWalking_5;
		if (!L_44)
		{
			goto IL_01a8;
		}
	...
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_45 = __this->___mainCamera_6;
		NullCheck(L_45);
		...
		double L_49 = __this->___thresholdAngle_10;
	...
	{
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_50 = __this->___mainCamera_6;
		NullCheck(L_50);
...
IL_01a8:
	{
		// if (isWalking)
		bool L_54 = __this->___isWalking_5;
		if (!L_54)
		{
			goto IL_0245;
		}
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_55 = __this->___mainCamera_6;
		NullCheck(L_55);
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_59 = __this->___mainCamera_6;
		NullCheck(L_59);
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_63), L_58, (0.0f), L_62, /*hidden argument*/NULL);
		V_2 = L_63;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_64;
		L_64 = Vector3_get_normalized_m736BBF65D5CDA7A18414370D15B4DFCC1E466F07_inline((&V_2), NULL);
		float L_65 = __this->___speed_7;
		...
		L_71 = Quaternion_get_eulerAngles_m2DB5158B5C3A71FD60FC8A6EE43D3AAA1CFED122_inline((&V_3), NULL);
		float L_72 = L_71.___y_3;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_73;
		memset((&L_73), 0, sizeof(L_73));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_73), (0.0f), ((-L_72)), (0.0f), /*hidden argument*/NULL);
		Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_74;
		L_74 = Quaternion_Euler_m66E346161C9778DF8486DB4FE823D8F81A54AF1D_inline(L_73, NULL);
		V_1 = L_74;
...
IL_0245:
	{
		// if (freezeYPosition)
		bool L_79 = __this->___freezeYPosition_11;
		if (!L_79)
		{
			goto IL_0283;
		}
	}
	{
		...
		float L_84 = __this->___yOffset_12;
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_88), L_83, L_84, L_87, /*hidden argument*/NULL);
		NullCheck(L_80);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AutoWalk__ctor_mE6B0428774622A36D2B9662C5BDD9EDC92095B9C (AutoWalk_t866CC412078ADE3A6A4941ADE1143F8EEA7A29E7* __this, const RuntimeMethod* method) 
{
	{
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
